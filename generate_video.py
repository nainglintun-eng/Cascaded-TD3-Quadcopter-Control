"""
generate_td3_video.py

Generates a video visualization of the trained cascaded TD3 quadcopter
...
class TD3QuadcopterVisualizer:
    """Generates video visualization of TD3 quadcopter trajectory simulation"""
    ...
    def __init__(self, position_agent_path, attitude_agent_path=None, output_dir='videos'):
        ...
        # Load agents
        print("Loading trained TD3 agents...")
    ...
    def _load_position_agent(self, path):
        ...
        if os.path.exists(path):
            try:
                ...
                print(f"  ✓ Loaded TD3 position agent from: {path}")
    ...
    def _load_attitude_agent(self, path):
        ...
        try:
            ...
            agent.critic.load_state_dict(checkpoint['critic_state_dict'], strict=False)
            agent.critic_target.load_state_dict(checkpoint['critic_target_state_dict'], strict=False)
            print(f"  ✓ Loaded TD3 attitude agent from: {path}")
        except Exception as e:
    ...
    def create_3d_animation(self, filename='td3_trajectory.mp4', 
        ...
        ax.set_title('Cascaded TD3 Quadcopter Trajectory Tracking\nExpanding Helix Mission', 
    ...
    def create_dashboard_animation(self, filename='td3_dashboard.mp4',
        ...
        ax_3d.set_title('Cascaded TD3 Quadcopter Trajectory Tracking', fontweight='bold', fontsize=11)
        ...
        ax_att.set_title('TD3 Attitude Control', fontweight='bold', fontsize=10)
        ...
        ax_err.set_title('TD3 Tracking Error', fontweight='bold', fontsize=10)
        ...
        ax_thrust.set_title('TD3 Total Thrust', fontweight='bold', fontsize=10)
        ...
        ax_torques.set_title('TD3 Control Torques', fontweight='bold', fontsize=10)
        ...
        def animate(frame):
            ...
            text_str = (f"TD3 SIMULATION TELEMETRY\n"
                       f"{'='*25}\n"
...
def main():
    """Main function to generate videos from trained TD3 agents"""
    ...
    ATTITUDE_AGENT_PATH = r'weights\attitude_best.pth'  # Update with your actual path
    DURATION = 50.0  # seconds
    OUTPUT_DIR = 'td3_videos'
    
    print("\n" + "="*70)
    print("TD3 QUADCOPTER VIDEO GENERATION")
    print("="*70)
    print("\nTD3 Features:")
    print("  ✓ Twin Critics (reduces overestimation)")
    ...
    if not os.path.exists(POSITION_AGENT_PATH):
        print(f"\n⚠ Warning: TD3 Position agent not found at: {POSITION_AGENT_PATH}")
        print("\nLooking for TD3 position checkpoints in results directory:")
        results_dir = os.path.dirname(POSITION_AGENT_PATH)
        if os.path.exists(results_dir):
            for f in os.listdir(results_dir):
                if f.endswith('.pth') and 'position' in f.lower():
                    print(f"  - {f}")
        else:
    ...
    # Create visualizer
    visualizer = TD3QuadcopterVisualizer(
    ...
    print("\n" + "="*70)
    print("TD3 VIDEO GENERATION COMPLETE!")
